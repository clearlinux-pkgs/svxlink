...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707106251
mkdir -p clr-build
pushd clr-build
...
%defattr(-,root,root,-)
/V3/usr/bin/devcal
/V3/usr/bin/remotetrx
/V3/usr/bin/siglevdetcal
/V3/usr/bin/svxlink
/V3/usr/bin/svxreflector
/V3/usr/lib64/svxlink/*.so
/usr/bin/devcal
/usr/bin/remotetrx
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libasyncaudio.so.1.6.0
/V3/usr/lib64/libasynccore.so.1.6.0
/V3/usr/lib64/libasynccpp.so.1.6.0
/V3/usr/lib64/libasyncqt.so.1.6.0
/V3/usr/lib64/libecholib.so.1.3.3
